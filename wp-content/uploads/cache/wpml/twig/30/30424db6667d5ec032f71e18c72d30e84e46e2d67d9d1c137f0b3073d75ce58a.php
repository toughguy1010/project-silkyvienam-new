...
class __TwigTemplate_7aa3eb41179db2965218e8d679712c0523ffe753249cfc85512675788908d505 extends \WPML\Core\Twig\Template
{
    ...
    <a class=\"nav-tab {{ menu.multilingual.active }}\" href=\"{{ menu.multilingual.url }}\">{{ menu.multilingual.title }}</a>
    {%  if can_operate_options %}
        <a class=\"nav-tab {{ menu.multi_currency.active }}\" href=\"{{ menu.multi_currency.url }}\">{{ menu.multi_currency.name }}</a>
    {% endif %}
</nav>", "nav-menus-standalone.twig", "E:\\wamp64\\www\\test02\\wp-content\\plugins\\woocommerce-multilingual\\templates\\nav-menus-standalone.twig");
    }
}
