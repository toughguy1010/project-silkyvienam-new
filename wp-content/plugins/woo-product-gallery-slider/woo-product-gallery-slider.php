...
final class Cipg_Slider {
	...
	public function wpgs_plugin_row_meta( $links ) {
		$row_meta = array(
			...
			'docs'     => '<a href="' . esc_url( 'http://codeixer.com/twist' ) . '" target="_blank" aria-label="' . esc_attr__( 'PRO Version', 'wpgs' ) . '" style="color:green;font-weight:600;">' . esc_html__( 'Go PRO', 'wpgs' ) . '</a>',
...
function twistgetpro_admin_notice__sdssuccess() {
	...
	?>
			<div data-dismissible="twist-getpro-notice-30" class="info notice notice-info is-dismissible">
				...
				<p class="exclusive-txt">Limited time offer for only those who have downloaded <b>Product Gallery Slider for WooCommerce</b> and want to go <a target="_blank"  href="https://www.codeixer.com/product-gallery-slider-for-woocommerce/?utm_source=twist_plugin&utm_medium=first_visit&utm_campaign=gallery_plugin_visit" >PRO.</a> <br>
