		...
		\CSF::createSection( $prefix, array(
			...
			'fields' => array(
				...
				array(
					...
					'class'    => 'cix-only-pro',
					'inline'   => true,
					'subtitle' => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'desc'     => 'Effect Between Product Images',
					'options'  => array(
						'false'    => __( 'Slide', 'wpgs' ),
						'only_pro' => __( 'Fade', 'wpgs' ),
				...
				array(
					...
					'options'  => array(
						...
						'ondemand'    => __( 'On Demand', 'wpgs' ),
						'progressive' => __( 'Progressive', 'wpgs' ),
					),
					'default'  => 'disable',
				...
				array(
					...
					'class'    => 'cix-only-pro',
					'subtitle' => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'title'    => __( 'Slide Image Caption', 'wpgs' ),
				...
				array(
					...
					'type'       => 'switcher',
					'class'      => 'cix-only-pro',
					'title'      => __( 'Arrows Animation', 'wpgs' ),
					'subtitle'   => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
		...
		\CSF::createSection( $prefix, array(
			...
			'fields' => array(
				...
				array(
					...
					'class'       => 'cix-only-pro',
					'subtitle'    => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'title'       => __( 'Lightbox Animation', 'wpgs' ),
		...
		\CSF::createSection( $prefix, array(
			...
			'fields' => array(
				...
				array(
					...
					'class'       => 'cix-only-pro',
					'subtitle'    => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'title'       => __( 'Thumbnails Position', 'wpgs' ),
					'subtitle'    => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'placeholder' => 'Select an option',
					'options'     => array(
				...
				array(
					...
					'type'     => 'switcher',
					'subtitle' => 'Available in <a target="_blank" href="https://codeixer.com/twist">Pro Version!</a>',
					'title'    => __( 'LightBox For Thumbnails', 'wpgs' ),
					'class'    => 'cix-only-pro',
