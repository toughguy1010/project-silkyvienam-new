				...
				foreach ( $grouped_product_columns as $column_id ) {
					...
					switch ( $column_id ) {
						case 'quantity':
							...
							break;
						case 'label':
							$value  = '<div class ="colletion-product-content">
							<label for="product-' . esc_attr( $grouped_product_child->get_id() ) . '">';
							$value .= $grouped_product_child->is_visible() ? '
							<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', $grouped_product_child->get_permalink(), $grouped_product_child->get_id() ) ) . '">' . $grouped_product_child->get_name() . '</a>' : $grouped_product_child->get_name();
							$value .= '</label>
						...
						case 'price':
							...
							break;
						default:
							$value = get_the_post_thumbnail($grouped_product_child->get_id()) ;
							break;
					}
