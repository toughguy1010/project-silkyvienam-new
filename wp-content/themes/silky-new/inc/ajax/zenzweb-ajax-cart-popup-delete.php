...
add_action( 'wp_ajax_nopriv_zwc_cart_popup_delete', 'zenzweb_ajax_zwc_cart_popup_delete' );
add_action( 'wp_ajax_zwc_cart_popup_delete', 'zenzweb_ajax_zwc_cart_popup_delete' );

function zenzweb_ajax_zwc_cart_popup_delete(){
