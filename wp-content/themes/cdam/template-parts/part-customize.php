      ...
      <form class="right" id="form-customize">
        ...
        <div class="measurements step-1 show">
          ...
          foreach ($measurements as $key => $measurement) {
            ...
            ?>
            <div class="item">
              <input class="size" data-size="<?php echo $key; ?>" type="number" min="1" max="999" name="measure[]" value="" <?php echo $measurement['require'] ? 'data-req="1"' : ''; ?>>
              <input type="hidden" name="typename[]" value="<?php echo $measurement['title']; ?>">
              <div class="wrap-title">
                <span class="title"><?php echo ($key+1).'. '.$measurement['title']; ?> <?php echo $measurement['require'] ? '<span class="required">*</span>' : ''; ?></span>
